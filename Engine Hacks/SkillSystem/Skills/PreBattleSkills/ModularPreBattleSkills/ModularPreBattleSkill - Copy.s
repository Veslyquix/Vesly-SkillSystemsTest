...
Preloop: @r0 has which entry to do in it
ldr r1, =ModularPreBattleSkills
mov r0, r6	@copy skill id into r0
@mov r0, #2 @test
...
@iteration 1: we do stuff based on #0x04, #0x05, and #0x06 in ModularPreBattleSkills
@iteration 2: we do stuff based on #0x07, #0x08, and #0x09 in ModularPreBattleSkills
@iteration 3: we do stuff based on #0x0A, #0x0B, and #0x0C in ModularPreBattleSkills
@etc.. 
